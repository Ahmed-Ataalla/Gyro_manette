...
void controle(void *parameters)
{
  ...
  while (1)
  {
    ...
    // theta_w += (Te / 1000) * -g.gyro.z; // axe z qui tourne intégrale de la vitesse de rotation division par 1000 pour passer en seconde avec le filtre sert a rien juste pour observer l'intégrale
    // Calcul simplifié
...
void setup() {
  ...
  kp_theta=2.5, kd_theta=0.052, kp_vit= 0.088, kd_vit= 0.01, theta0=0.02, Tau_D=400;
